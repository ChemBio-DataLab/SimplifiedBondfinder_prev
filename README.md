...
The machine-learning parts and the scripts for generating figures in the manuscript are stored in [Figure_scripts](https://github.com/ChemBio-DataLab/SimplifiedBondfinder/tree/main/Figure_scripts)
